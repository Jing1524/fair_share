...
describe('Dashboard', () => {
  it('should show a row for all shareholders', async () => {
    ...
    expect(screen.getByTestId('shareholder-Tonya-grants')).toHaveTextContent('2')
    expect(screen.getByTestId('shareholder-Tonya-group')).toHaveTextContent('founder')
    expect(screen.getByTestId('shareholder-Tonya-shares')).toHaveTextContent('1500')

    expect(screen.getByTestId('shareholder-Tony-grants')).toHaveTextContent('1')
    expect(screen.getByTestId('shareholder-Tony-group')).toHaveTextContent('employee')
    expect(screen.getByTestId('shareholder-Tony-shares')).toHaveTextContent('100')

    expect(screen.getByTestId('shareholder-Tiffany-grants')).toHaveTextContent('2')
    expect(screen.getByTestId('shareholder-Tiffany-group')).toHaveTextContent('employee')
    expect(screen.getByTestId('shareholder-Tiffany-shares')).toHaveTextContent('120')

    expect(screen.getByTestId('shareholder-Timothy-grants')).toHaveTextContent('1')
  ...
  it('should allow adding new shareholders', async () => {
    ...
    expect(await screen.findByTestId('shareholder-Mike-group')).toHaveTextContent('employee')
  }, 10000)
})
